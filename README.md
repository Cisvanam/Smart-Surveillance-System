...
Created a system that flags possible cheating in real time and sends a summary video and report to professors.

Built logic to exclude professors from being flagged.

Made sure to handle privacy concerns by encrypting data and setting time limits on storage.

Designed the system to be fair, minimize false flags, and work with existing university networks.
